  ...
  return (
    ...
    <div className="flex justify-center items-center mt-4">
      <form className="w-full bg-[#f4f4f4] h-[80vh] flex flex-col gap-8 items-center justify-center p-4 rounded shadow-md md-w-[70%] lg:w-[50%]" onSubmit={submitForm} >
            ...
            <input type="text" name="email" className="grow" value={loginForm.email} onChange={handleChange} placeholder="Email or Username" />
            </label>
            <label className="input input-bordered flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path fillRule="evenodd" d="M14 6a4 4 0 0 1-4.899 3.899l-1.955 1.955a.5.5 0 0 1-.353.146H5v1.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2.293a.5.5 0 0 1 .146-.353l3.955-3.955A4 4 0 1 1 14 6Zm-4-2a.75.75 0 0 0 0 1.5.5.5 0 0 1 .5.5.75.75 0 0 0 1.5 0 2 2 0 0 0-2-2Z" clipRule="evenodd" /></svg>
            <input type="password" name="password" className="grow" onChange={handleChange} value={loginForm.password} placeholder="Password"/>
            </label>
            {loginForm.password && <div className="flex flex-col items-center gap-2">
        </div>
        }
