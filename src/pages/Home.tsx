...
<div className="hero min-h-screen mb-4" style={{backgroundImage: `url(${heroImg})`}}>
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      ...
      <Link to='/products' className="btn btn-neutral">Get Started</Link>
    </div>
  </div>
</div>
<div className="flex flex-row justify-center items-center py-8 text-2xl">Featured Products</div>
